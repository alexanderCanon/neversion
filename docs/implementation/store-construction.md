...
| 2026-05-12 | Infra / Store VPS deploy | Se agregó despliegue liviano sin Dokploy para store SSR: workflow GitHub Actions construye imagen Docker, publica en GHCR y despliega por SSH a una VPS con Docker Compose + Caddy. | Pendiente de validación en GitHub Actions y VPS real; no se ejecutó Docker local porque no está instalado en el entorno. |
