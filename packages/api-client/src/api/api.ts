...
export const APIS = [AccountsApiService, AssignmentsApiService, AuthApiService, ClientsApiService, GameSKUsApiService, GamesApiService, LoyaltyPointsApiService, NotificationsApiService, OrdersApiService, ProfilesApiService, ReservationsApiService, ServicesApiService, SubscriptionsApiService, VendorsApiService, VendorsPublicApiService];
