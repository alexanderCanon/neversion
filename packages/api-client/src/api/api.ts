...
export const APIS = [AccountsApiService, AssignmentsApiService, AuthApiService, ClientsApiService, DashboardApiService, NotificationsApiService, OrdersApiService, ProfilesApiService, ReservationsApiService, ServicesApiService, SubscriptionsApiService, VendorsPublicApiService];
