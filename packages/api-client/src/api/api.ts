...
export const APIS = [AccountsApiService, AssignmentsApiService, AuthApiService, ClientsApiService, DashboardApiService, GamesApiService, LoyaltyPointsApiService, NotificationsApiService, OrdersApiService, ProfilesApiService, ReservationsApiService, ServicesApiService, SubscriptionsApiService, VendorsApiService, VendorsPublicApiService];
