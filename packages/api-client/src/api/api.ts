...
export const APIS = [AccountsApiService, AssignmentsApiService, AuthApiService, ClientsApiService, DashboardApiService, LoyaltyPointsApiService, NotificationsApiService, OrdersApiService, ProfilesApiService, ReservationsApiService, ServicesApiService, SubscriptionsApiService, VendorsApiService, VendorsPublicApiService];
